...
if (isset($_POST["ssecteur"])) {
    $search = $_POST["ssecteur"];
    $stmt = $conn->prepare("select * FROM `secteur` where code LIKE CONCAT('%',?,'%') OR nom Like CONCAT('%',?,'%')");
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo "
                                                        <tr id=" . $row["code"] . ">
                                                            ...
                                                            <td data-target=\"name\">" . $row["type_minister"] . "</td>
                                                            <td data-target=\"name\">" . $row["categorie"] . "</td>";
