                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card row g-2 ">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="card-header"> <strong>Tableaux des villes</strong></h5>
                                </div>
                                <div class="col-md-4 "
                                        ...
                                        <div class="modal-content container-xxl">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col mb-0">
                                                        <label class="form-label"
                                                            for="basic-icon-default-company">ville</label>
                                                        <div class="input-group input-code">
                                                            <span id="basic-icon-code" class="input-group-text"><i
                                                ...
                                                <div class="col mb-0">
                                                    ...
                                                    <div class="input-group input-group-phone">
                                                        <span id="basic-icon-map-alt" class="input-group-text"><i
                                                                class="bx bx-map-alt"></i></span>
                                                        <select required name="region" id="region" class="form-select">
                                                ...
                                                <div class="col mb-0" style="margin-top: 9px;">
                                                    <button type="submit" name="Addville"
                        ...
                        if (isset($_POST["modifier"])) {
                            $id = $_POST["idvilleup"];
                            $nomville = $_POST["villeup"];
                            $nbregion = $_POST["regionvilleup"];
                            $queryup = "UPDATE `ville` SET `nom`='$nomville',`region`=$nbregion WHERE `code` LIKE '$id' ";
                        ...
                        if (isset($_GET["id_del"])) {
                            $id = $_GET["id_del"];
                            $query = "DELETE FROM `ville` WHERE `code`='$id'";
                        ...
                        <div class="table-responsive text-nowrap">
                            ...
                            if (isset($_POST["Addville"])) {
                                ...
                                $ville = $_POST["ville"];
                                $region = $_POST["region"];
                                $addquery = "INSERT INTO `ville`(`code`, `nom`, `region`) VALUES ('$code','$ville',$region)";
                                        ...
                                        while ($row = mysqli_fetch_assoc($query)) {
                                            echo "
                                                    <tr id=" . $row["code"] . ">
                                                        ...
                                                        <td data-target=\"region\">";
                                            $var = $row["region"];
                                            $qdirection = "SELECT * FROM `data_r`.`region` WHERE `code` = '$var'";
