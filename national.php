            ...
            <form action="Demande.php" id="form" method="post">
                ...
                <div class="col mb-0" style="margin-top: 9px;">
                    <div class="input-group input-group-merge">
                        <button style="background-color: #6391ad; border-color: #6391ad; box-shadow:0 0.125rem 0.25rem 0 rgb(99 145 173 / 62%);" type="submit" name="DemandeN" class="btn btn-info btn-lg">Demande</button>
                    </div>
                </div>
            </form>
        </div>
